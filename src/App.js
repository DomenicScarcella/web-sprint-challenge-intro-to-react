...
const App = () => {
  ...
  return (
    <div className="App">
      <h1 className="Header">I'm not visually expressive, and I don't make things;  I fix things that are broken, I spot errors that other people miss, and I correct things.  This is excruciating for me:  staring at a blank page and having to make something.  I know none of this is what you wanted.  But it's what I do when I have a blank page.  I hate creating visual things, and I'm awful at it.  Everything I've done at Lambda so far has been copying things that work and tweaking them to fit the details of the assignment/project.  But I don't know what to copy for this project.  And I have no idea how to create things from scratch.  There aren't even multiple tests in the CodeGrade for me to monitor my progress.  Totally lost.  I don't want to be a web designer.  I don't want to be a person who has to make things.  I know I'm absolutely failing this Sprint Challenge.  I'm not writing any of this to be funny nor cute.  I'm doing this because the alternative is descending into a fit of rage.  Here are some Star Wars characters:</h1>
